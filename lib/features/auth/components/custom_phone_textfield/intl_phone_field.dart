...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  Color _validBorderColor = primaryColor;
  final Color _focusBorderColor = lightGreyColor;
  String _phoneNum = "";
  Color _notValidBorderColor = Colors.transparent;
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  labelStyle: const TextStyle(
                      color: textColor, fontWeight: FontWeight.w400),
                  labelText: _phoneNum.isNotEmpty ? "" : "Phone Number",
              ...
              onChanged: (value) async {
                ...
                setState(() {
                  _phoneNum = value;
                  _notValidBorderColor = doesNotMatchError;
                });
                ...
                FittedBox(
                  child: Text(
                    ...
                    style: TextStyle(
                        color: textColor,
                        fontSize: 14.0,
                        fontWeight: _phoneNum.isNotEmpty
                            ? FontWeight.w700
                            : FontWeight.w400),
                  ),
                ),
